...
def setup_help_handlers(bot):
    ...
    def generate_help_text(user_id: int) -> str:
        ...
        base_help = (
            ...
            "Покупка Эссенции онлайн недоступна в первые дни выхода бота.\n"
            "\n"
            "❗️ Комиссия на переводы Ар между игроками составляет 5% ❗️\n"
        )
        ...
        admin_help = (
            ...
            "   Валюта: es (Эссенция), ar (Ары)\n"
            "• /incash - пополнить счёт банка при помощи налички\n"
            "• /outcash - снять наличку со счёта банка\n"
